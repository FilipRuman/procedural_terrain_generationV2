...
public partial class TerrainGen : Node3D
{
    ...
    public struct ChunkData
    {
        ...
        public Vector2I world_pos;
        public ObjectsGenerator.ObjectTypeSpawnData[] objects_data;
        public ChunkData(ThreadSafeGroundMeshGen.OutputData mesh,
                         BiomeGenerator.OutputData biome, Vector2I world_pos, ObjectsGenerator.ObjectTypeSpawnData[] objects_data)
        {
            this.mesh = mesh;
            this.biome = biome;
    ...
    private void ChunkDataGenerationLoop()
    {
        ...
        try
        {
            ...
            // Initial terrain generation
            {
                ...
                RunTerrainGeneration(chunks_to_generate.ToArray(), last_player_chunk_grid_pos * chunk_size, water_data);
                load_at_once = true;
            }
            ...
            while (true)
            {
                ...
                last_player_chunk_grid_pos = current_player_chunk_grid_pos;
                RunTerrainGeneration(chunk_change.to_generate_relative_pos, current_player_chunk_grid_pos * chunk_size, water_data);
                load_at_once = false;
...
Vector2I player_pos_snapped_to_chunk, WaterGen.WaterDataGrid water_data)
    {
