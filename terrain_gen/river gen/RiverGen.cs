...
using Godot;
[Tool]
public partial class RiverGen : Node3D
{
    ...
    public OutputData GenerateCell(Vector2 base_pos, ThreadSafeGroundMeshGen mesh_gen, int mesh_chunk_size)
    {
        ...
        Dictionary<Vector2, LakeData> world_pos_lakes = new();
    ...
    private float GetWatterLevelOfLakeSystem()
    {
